...
namespace Zombie.Active
{
    class MonsterB : Character
    {
        ...
        public MonsterB(string name, int hp, Vector2 position, Vector2 size, Vector2 velocity)
        ...
        public void Initialize() {
            ...
            //RUN
            for (int i = 0; i < 6; i++) {
                motion.Add(i, new Rectangle(280 * (i % 3), 200 * (int)(i / 3), 280, 200));
            }
            motion.Add(6, new Rectangle(280 * 0, 200 * 2, 280, 200));
            motion.Add(7, new Rectangle(280 * 1, 200 * 2, 280, 200));
